...
/**
 * A custom lock icon that pulls its color from the Ant Design theme.
 */
export const MagLockIcon = (props: React.SVGProps<SVGSVGElement>) => {
    const { token } = antdTheme.useToken();

    return (
        <svg
            fill={token.colorText} // Use the theme's text color
            {...props}
